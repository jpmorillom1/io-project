...
import type { Mensaje, ChatResponse, SolicitudAprobacion, ModeloTransporte } from '@/types/io'

const SESSION_KEY = 'io_sesion_id'

type Modulo = 'lp' | 'transporte'
 ...
 * se adapte automáticamente (LP ⇄ Transporte) según lo que el chat detecte.
 */
